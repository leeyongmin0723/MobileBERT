...
# 2. 데이터 확인
path = "Airline_review_sentiment.csv"
df = pd.read_csv(path, encoding="utf-8")
data_X = list(df['review_text'].values)
...
# 8. 학습 종료 후 epoch별 학습 경과 및 검증 정확도 출력
...
# 9. 모델 저장
print("\n### 모델 저장 ###")
save_path = "mobilebert_custom_model_airline"
